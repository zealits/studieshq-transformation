        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <Link to="/" className="inline-block mb-6">
              <img src="/logo.png" alt="StudiesHQ Logo" className="h-10" />
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/find-work" className="text-gray-300 hover:text-white transition-colors">
                  Find Work
                </Link>
              </li>
              <li>
                <Link to="/create-profile" className="text-gray-300 hover:text-white transition-colors">
                  Create Profile
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/enterprise-solutions" className="text-gray-300 hover:text-white transition-colors">
        ...
        <div className="mt-12 pt-8 border-t border-gray-700">
          ...
          <div className="mt-6">
            <p className="text-gray-400 text-sm">
              &copy; {new Date().getFullYear()} StudiesHQ, by Agile Labs. All rights reserved.
            </p>
          </div>
        </div>
      </div>
