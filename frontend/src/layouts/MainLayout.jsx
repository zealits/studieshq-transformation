      ...
      <footer className="bg-white border-t">
        <div className="container-custom py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h4 className="font-bold text-lg mb-4" style={{ background: "linear-gradient(to right, #FF017C, #D67BFF)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>StudiesHQ</h4>
              ...
              <div className="flex space-x-4">
                <a
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.background = "linear-gradient(to right, #D67BFF, #FF017C)";
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.background = "linear-gradient(to right, #FF017C, #D67BFF)";
                  }}
                >
            ...
            <div>
              <h4 className="font-bold text-lg mb-4" style={{ background: "linear-gradient(to right, #FF017C, #D67BFF)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>For Freelancers</h4>
              <ul className="space-y-2">
                <li>
                  <button
                    onClick={handleHowItWorksClick}
                    className="text-gray-600 hover:text-[#FF017C] transition-colors text-left"
                  >
                    How it Works
                  </button>
                </li>
                <li>
                  <Link
                    ...
                    className="text-gray-600 hover:text-[#FF017C] transition-colors"
                  >
                    Find Jobs
                  </Link>
                </li>
            ...
            <div>
              <h4 className="font-bold text-lg mb-4" style={{ background: "linear-gradient(to right, #FF017C, #D67BFF)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>For Clients</h4>
              <ul className="space-y-2">
                <li>
                  <button
                    onClick={handleHowItWorksClick}
            ...
            <div>
              <h4 className="font-bold text-lg mb-4" style={{ background: "linear-gradient(to right, #FF017C, #D67BFF)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>Company</h4>
              <ul className="space-y-2">
                <li>
                  <Link to="/about" className="text-gray-600 hover:text-[#FF017C] transition-colors">
                    About Us
                  </Link>
                </li>
                <li>
                  <Link to="/contact" className="text-gray-600 hover:text-[#FF017C] transition-colors">
                    Contact
                  </Link>
                </li>
              </ul>
          ...
          <div className="mt-12 pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="mt-4 md:mt-0 flex gap-6">
              <Link to="/terms" className="text-gray-500 text-sm hover:text-[#FF017C] transition-colors">
                Terms
              </Link>
              <Link to="/privacy" className="text-gray-500 text-sm hover:text-[#FF017C] transition-colors">
                Privacy
              </Link>
              <Link to="/security" className="text-gray-500 text-sm hover:text-[#FF017C] transition-colors">
                Security
              </Link>
            </div>
          </div>
